...
exports.registerjobapplied = async(req,res,next)=>{
    try{
        const {addedby,title,des,companyname,salary,appliedby,status,date,time} = req.body;
        await jobappliedService.registerjobapplied(addedby,title,des,companyname,salary,appliedby,status,date,time);
